...
public class ConsumerVerticleAdi extends AbstractVerticle {
    ...
    // LoggerFactory.getLogger(ConsumerVerticle.class);

    // private static final String EH_COMPATIBLE_CONNECTION_STRING_FORMAT =
    // "Endpoint=%s/;EntityPath=%s;"
    ...
    // "sb://iothub-ns-pythongate-16825588-e9903a966d.servicebus.windows.net/";
    ...
    // // az iot hub policy show --name service --query primaryKey --hub-name {your
    // IoT
    // // Hub name}
    // private static final String IOT_HUB_SAS_KEY =
    // "oTkbizNC5B6ai0eCQxgaOl8g9yTfVHhLwzhDaJLHcE0=";
    ...
    private static final String IOT_HUB_SAS_KEY = "LU50/qvkItaNB7bCtFYSPQ==";
